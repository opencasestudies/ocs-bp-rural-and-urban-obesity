...
# print(pdf_obesity[52]) would show the entire contents of pthe first page of the table 
```
...
```{r}
Women <-glue::glue("Women{pull(Women_BMI,country_split)}")
head(Women)
...
BMI_numeric %<>% mutate(Country =pull(BMI,Country), Sex =pull(BMI,Sex))
head(BMI_numeric)
