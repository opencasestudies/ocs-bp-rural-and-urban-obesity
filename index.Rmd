...
dim(Women_BMI)
```
Great! There are 200 rows of characeter strings with the BMI data like we expected. 
...
Let's use the `first()` function of the `dplyr` package to get a  reminder of what just the first row of the country_split column of the Women_BMI data looks like.
...
We can see from our pdf and our object called `header` what the header was like in the orginal pdf document. We need to add column names to our data based on the orginal data.
